    ...
    <div className="flex flex-col">
      {sortedUsers?.map((otherUser) => {
        ...
        return (
          <div
            key={otherUser._id}
            className="h-16 flex items-center px-3 gap-3 border-b-2 border-zinc-500 bg-zinc-600 text-white hover:bg-zinc-700"
            onClick={() =>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center text-sm mt-1 min-w-0">
                {(conversation?.lastMessage?.sender?.email === user.email ||
                  ...
                  <div className="text-xs text-gray-300 pr-1 flex-shrink-0">
                    {status === "read" ? (
                ...
                <p className="font-light pl-1 text-gray-100 truncate flex-1">
                ...
                {conversation?.unreadCount > 0 && (
                  <span className="ml-2 flex-shrink-0 h-5 w-5 rounded-full bg-green-600 text-xs text-black font-medium flex justify-center items-center">
